...
export default function ComplianceAddJurisdictionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(22,28,36,0.74)] px-4 py-8">
      <div className="relative max-h-[90vh] w-full max-w-[840px] overflow-y-auto rounded-[32px] bg-white shadow-[0_40px_120px_-56px_rgba(15,23,42,0.75)]">
              ...
              {LEVEL_OPTIONS.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={
                      active
                        ? "inline-flex h-16 items-center rounded-[18px] border border-[#13264e] bg-[#eef3ff] px-5 text-[16px] font-medium text-[#13264e]"
                        : "inline-flex h-16 items-center rounded-[18px] border border-[#d9e0ec] bg-white px-5 text-[16px] font-medium text-[#2a2f39] transition-colors hover:bg-[#f7f9fc]"
                    }
                  >
                    {option}
                  </button>
