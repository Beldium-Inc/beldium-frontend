        ...
        <Form form={form} layout="vertical" autoComplete="off">
          ...
          >
            <Radio.Group>
              <div className="w-full flex flex-col gap-3">
                <Radio value="">Mining Company</Radio>
                <Radio value="">Licensed Miner</Radio>
                <Radio value="">Leased Holder</Radio>
                <Radio value="">Operator / Contractor</Radio>
              </div>
            </Radio.Group>
          </Form.Item>
          ...
          >
            <Select placeholder="Select your local government area">
              <Select.Option value="ng">Ido</Select.Option>
              <Select.Option value="us">Lafia </Select.Option>
            </Select>
          </Form.Item>
