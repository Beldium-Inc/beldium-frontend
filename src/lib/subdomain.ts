...
export const COMPLIANCE_HOSTS = ["compliance.beldium.com", "stg-compliance.beldium.com"];
...
export const MARKETPLACE_HOSTS = ["marketplace.beldium.com", "stg-marketplace.beldium.com"];
